    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="86r4kw4f95xh868"`, // Adjust for the correct lesson
        });
      ...
      <div className="w-[90%] max-w-screen-2xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">Lesson Overview: Food 3</h2>
            <p className="text-gray-700 mb-4">
              Here are more phrases to expand your food and dining vocabulary:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Ko norėtumėte?</strong> – “What would you like?”
              </li>
              <li>
                <strong>Aš norėčiau…</strong> – “I would like…”
              </li>
              <li>
                <strong>Ar turite meniu?</strong> – “Do you have a menu?”
              </li>
              <li>
                <strong>Aš esu vegetaras/vegetarė</strong> – “I am a vegetarian” (masc/fem)
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              These expressions will help you place orders and mention dietary preferences in
              Lithuanian. Give the matching game a try below!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("86r4kw4f95xh868"); // Use dynamic lessonId if necessary
