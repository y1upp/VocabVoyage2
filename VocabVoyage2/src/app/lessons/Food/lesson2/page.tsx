    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="z417b95816vapxs"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">
              Lesson Overview: Food 2
            </h2>
            <p className="text-gray-700 mb-4">
              Continue expanding your Lithuanian food vocabulary with these phrases:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Pusryčiai, pietūs, vakarienė</strong> — “Breakfast, lunch, dinner”
              </li>
              <li>
                <strong>Aš esu alkanas/alkana</strong> — “I’m hungry” (masculine / feminine)
              </li>
              <li>
                <strong>Ar galėčiau sąskaitą, prašau?</strong> — “Could I have the bill, please?”
              </li>
              <li>
                <strong>Skanu!</strong> — “Tasty!” or “Delicious!”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Learning these phrases will help you navigate meals and express yourself at 
              restaurants. Practice matching them below!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("z417b95816vapxs"); // Use dynamic lessonId if necessary
