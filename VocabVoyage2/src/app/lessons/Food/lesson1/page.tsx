    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="5um4ba9a1qhis47"`, // Adjust for the correct lesson
        });
      ...
      <div className="w-[90%] max-w-screen-2xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">Lesson Overview: Food 1</h2>
            <p className="text-gray-700 mb-4">
              In this lesson, you'll learn a few key words and phrases around eating and drinking in
              Lithuanian:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Norėčiau valgyti/gerti</strong> — “I’d like to eat/drink”
              </li>
              <li>
                <strong>Vanduo</strong> — “Water”
              </li>
              <li>
                <strong>Kava</strong> — “Coffee”
              </li>
              <li>
                <strong>Arbata</strong> — “Tea”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Practice asking for food or drink items in Lithuanian! Scroll down for the matching
              game to help you remember these words.
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("5um4ba9a1qhis47"); // Use dynamic lessonId if necessary
