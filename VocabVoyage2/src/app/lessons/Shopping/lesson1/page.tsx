    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="5w5wwn279u9dh35"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">
              Lesson Overview: Shopping 1
            </h2>
            <p className="text-gray-700 mb-4">
              Learn essential phrases for shopping in Lithuanian:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Kiek tai kainuoja?</strong> — “How much does this cost?”
              </li>
              <li>
                <strong>Ar priimate kreditines korteles?</strong> — “Do you accept credit cards?”
              </li>
              <li>
                <strong>Aš tik žiūriu</strong> — “I’m just looking”
              </li>
              <li>
                <strong>Ar galiu pasimatuoti?</strong> — “Can I try it on?”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              These phrases will help you ask prices, check payment options, or try on items. Scroll
              down to match the Lithuanian words to their English translations.
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("5w5wwn279u9dh35"); // Use dynamic lessonId if necessary
