    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="96mz4r6ga6j841g"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">
              Lesson Overview: Shopping 3
            </h2>
            <p className="text-gray-700 mb-4">
              In this lesson, you’ll learn how to bargain, ask for a fitting room, and finalize your purchases in Lithuanian:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Tai per brangu</strong> — “That’s too expensive”
              </li>
              <li>
                <strong>Ar galite suteikti nuolaidą?</strong> — “Can you give a discount?”
              </li>
              <li>
                <strong>Kur yra persirengimo kabina?</strong> — “Where is the fitting room?”
              </li>
              <li>
                <strong>Norėčiau nusipirkti šitą</strong> — “I’d like to buy this”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Review these phrases, then scroll down to practice matching the Lithuanian words with their English translations!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("96mz4r6ga6j841g"); // Use dynamic lessonId if necessary
