    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="ss039592xyg0306"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">
              Lesson Overview: Shopping 2
            </h2>
            <p className="text-gray-700 mb-4">
              Learn additional Lithuanian phrases for shopping:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Man reikia kvito</strong> — "I need a receipt"
              </li>
              <li>
                <strong>Aš ieškau batų</strong> — "I’m looking for shoes"
              </li>
              <li>
                <strong>Koks jūsų dydis?</strong> — "What’s your size?"
              </li>
              <li>
                <strong>Ar galiu tai grąžinti?</strong> — "Can I return this?"
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              With these phrases, you can handle more detailed shopping interactions. Scroll down to
              play the matching game and solidify your knowledge!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("ss039592xyg0306"); // Use dynamic lessonId if necessary
