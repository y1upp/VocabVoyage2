    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="2455439j17ztd9k"`, // Adjust for the correct lesson
        });
      ...
      <div className="w-[90%] max-w-screen-2xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">Lesson Overview: Places 2</h2>
            <p className="text-gray-700 mb-4">
              In this lesson, you'll learn additional vocabulary for traveling and finding your way
              around.
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Traukinių stotis</strong> — “Train station”
              </li>
              <li>
                <strong>Oro uostas</strong> — “Airport”
              </li>
              <li>
                <strong>Kiek laiko tai užtruks?</strong> — “How long will it take?”
              </li>
              <li>
                <strong>Aš pasiklydau</strong> — “I am lost”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Whether you're traveling by train or plane, these phrases will help you ask for
              directions or clarify how long your journey will be. Scroll down to practice matching
              them below!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("2455439j17ztd9k"); // Use dynamic lessonId if necessary
