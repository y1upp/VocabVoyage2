    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="zid81656a163vm3"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">
              Lesson Overview: Places 1
            </h2>
            <p className="text-gray-700 mb-4">
              In this lesson, you'll learn how to ask and give directions in Lithuanian, as well as
              locate common places. Review these phrases first:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Kur yra viešbutis?</strong> – “Where is the hotel?”
              </li>
              <li>
                <strong>Restoranas yra netoliese</strong> – “The restaurant is nearby.”
              </li>
              <li>
                <strong>Pasukite į kairę</strong> – “Turn left.”
              </li>
              <li>
                <strong>Pasukite į dešinę</strong> – “Turn right.”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Once you've reviewed these words and expressions, scroll down to practice matching
              them in the game below!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("zid81656a163vm3"); // Use dynamic lessonId if necessary
