    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="08ve126is5d1605"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">
              Lesson Overview: Places 3
            </h2>
            <p className="text-gray-700 mb-4">
              Continue exploring how to navigate Lithuanian streets and cities. This lesson covers
              more phrases to help you find your way around.
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Eikite tiesiai</strong> — “Go straight”
              </li>
              <li>
                <strong>Ar tai toli?</strong> — “Is it far?”
              </li>
              <li>
                <strong>Kaip nuvykti į miesto centrą?</strong> — “How do I get to the city center?”
              </li>
              <li>
                <strong>Man reikia taksi</strong> — “I need a taxi”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Familiarize yourself with these directions and questions, then test yourself in the
              matching game below!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("08ve126is5d1605"); // Use dynamic lessonId if necessary
