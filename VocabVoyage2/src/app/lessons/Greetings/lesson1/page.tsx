    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="7t0583fsmt1zf9b"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            ...
            <p className="text-gray-700 mb-2">
              In this lesson, you’ll learn common Lithuanian greetings. Review these phrases and
              notes before jumping into the matching game:
            </p>
            <ul className="list-disc list-inside text-gray-800">
              <li>
                <strong>Labas</strong> – A casual greeting similar to “Hi” or “Hello.”
              </li>
              <li>
                <strong>Laba diena</strong> – A more formal greeting, literally “Good day.”
              </li>
              <li>
                <strong>Viso gero</strong> – Means “Goodbye,” used in everyday farewells.
              </li>
              <li>
                <strong>Ačiū</strong> – Means “Thank you,” essential for polite conversation.
              </li>
              <li>
                <strong>Prašom</strong> – Means “You’re welcome” or “Please,” depending on context.
              </li>
            </ul>
            <p className="text-gray-700 mt-2">
              Pay attention to spelling and pronunciation. After reviewing, scroll down to practice
              with the matching game!
            </p>
          </div>
...
{isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("7t0583fsmt1zf9b"); // Use dynamic lessonId if necessary
