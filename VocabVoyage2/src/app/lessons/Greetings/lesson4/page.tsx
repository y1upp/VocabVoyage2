    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="69r236671i443rk"`, // Adjust for the correct lesson
        });
      ...
      <div className="w-[90%] max-w-screen-2xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">Lesson Overview: Greetings</h2>
            <p className="text-gray-700 mb-4">
              In this lesson, you’ll learn a few more ways to greet or respond in Lithuanian:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Kaip sekasi?</strong> — “How are you?”
              </li>
              <li>
                <strong>Labas vakaras</strong> — “Good evening”
              </li>
              <li>
                <strong>Gerai</strong> — “Good” or “Well”
              </li>
              <li>
                <strong>Man viskas gerai, ačiū</strong> — “I’m all good, thanks”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Reviewing these words and phrases will help you be polite and friendly in Lithuanian
              during different times of the day. Practice in the matching game below to lock them
              in!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("69r236671i443rk"); // Use dynamic lessonId if necessary
