    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="46x30klb07vjx20"`, // Adjust for the correct lesson
        });
      ...
      <div className="w-[90%] max-w-screen-2xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">
              Lesson Overview: Greetings 5
            </h2>
            <p className="text-gray-700 mb-4">
              In this lesson, you’ll learn additional polite expressions to use in Lithuanian. Review
              these examples, then practice in the matching game below.
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Atsiprašau</strong> – “I’m sorry” or “Excuse me”
              </li>
              <li>
                <strong>Ar galite man padėti?</strong> – “Can you help me?”
              </li>
              <li>
                <strong>Prašau, kalbėkite lėčiau</strong> – “Please speak more slowly”
              </li>
              <li>
                <strong>Aš nesuprantu</strong> – “I don’t understand”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              These phrases can be very useful when traveling or conversing with native speakers.
              Keep them handy and don’t be afraid to say <em>Atsiprašau</em> if you need assistance!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("46x30klb07vjx20"); // Use dynamic lessonId if necessary
