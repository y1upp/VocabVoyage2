    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="9a78026fx9v1h09"`, // Adjust for the correct lesson
        });
      ...
      <div className="w-[90%] max-w-screen-2xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">Lesson Overview: Second Greetings
            </h2>
            <p className="text-gray-700 mb-4">
              In this lesson, you'll learn more ways to greet or introduce yourself in Lithuanian.
              Take a moment to review these phrases before playing the matching game:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Koks tavo vardas?</strong> – "What's your name?"
              </li>
              <li>
                <strong>Mano vardas yra…</strong> – "My name is..."
              </li>
              <li>
                <strong>Malonu susipažinti</strong> – "Nice to meet you"
              </li>
              <li>
                <strong>Iki pasimatymo</strong> – "See you later"
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Understanding these phrases will help you hold basic conversations. When you’re ready,
              scroll down and begin the matching game to test your knowledge!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("9a78026fx9v1h09"); // Use dynamic lessonId if necessary
