    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="34l37r61q6lvzip"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md mb-8">
            ...
            <p className="text-gray-700 mb-2">
              In this lesson, you’ll learn how to count from one to ten in Lithuanian.
              Memorize these numbers and their Lithuanian equivalents before starting the matching game:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-2">
              <li><strong>One</strong> – Vienas</li>
              <li><strong>Two</strong> – Du</li>
              <li><strong>Three</strong> – Trys</li>
              <li><strong>Four</strong> – Keturi</li>
              <li><strong>Five</strong> – Penki</li>
              <li><strong>Six</strong> – Šeši</li>
              <li><strong>Seven</strong> – Septyni</li>
              <li><strong>Eight</strong> – Aštuoni</li>
              <li><strong>Nine</strong> – Devyni</li>
              <li><strong>Ten</strong> – Dešimt</li>
            </ul>
          </div>
...
{isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("34l37r61q6lvzip"); // Use dynamic lessonId if necessary
