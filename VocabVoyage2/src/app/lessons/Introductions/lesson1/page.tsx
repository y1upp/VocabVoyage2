    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="g61n8a57188oyxl"`, // Adjust for the correct lesson
        });
      ...
      <div className="w-[90%] max-w-screen-2xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">Lesson Overview: Intro 1</h2>
            <p className="text-gray-700 mb-4">
              In this lesson, you'll learn how to introduce yourself and ask for basic personal
              information in Lithuanian:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Koks tavo vardas?</strong> – “What is your name?”
              </li>
              <li>
                <strong>Mano vardas yra…</strong> – “My name is…”
              </li>
              <li>
                <strong>Kiek tau metų?</strong> – “How old are you?”
              </li>
              <li>
                <strong>Man … metų</strong> – “I am … years old”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              These phrases will help you introduce yourself and learn more about others in everyday
              conversations. Review them, then practice the matching game below to solidify your
              knowledge.
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("g61n8a57188oyxl"); // Use dynamic lessonId if necessary
