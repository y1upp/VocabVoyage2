    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="av9yn1ms57349n9"`, // Adjust for the correct lesson
        });
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            ...
            <p className="text-gray-700 mb-4">
              In this lesson, you’ll learn how to talk about where you're from and what you do:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                <strong>Iš kur tu esi?</strong> – “Where are you from?”
              </li>
              <li>
                <strong>Aš esu iš…</strong> – “I am from…”
              </li>
              <li>
                <strong>Kuo tu užsimi?</strong> – “What do you do?”
              </li>
              <li>
                <strong>Aš esu studentas/studentė</strong> – “I am a student”
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              These expressions help you introduce yourself in conversation. Once you’re ready, try
              matching the English and Lithuanian words below to practice what you’ve learned.
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("av9yn1ms57349n9"); // Use dynamic lessonId if necessary
