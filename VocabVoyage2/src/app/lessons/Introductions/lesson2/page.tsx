    ...
    const fetchUserAndWords = async () => {
      try {
        ...
        const wordsResponse = await pb.collection('words').getList(1, 50, {
          filter: `LessonId="7ie60omtn8uob7i"`, // Adjust for the correct lesson
        });
      ...
      <div className="w-[90%] max-w-screen-2xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="bg-[#F0F8E1] p-8 flex-1 overflow-y-auto rounded-r-lg">
          ...
          <div className="p-4 bg-white rounded shadow mb-8">
            <h2 className="text-2xl font-bold text-[#007C55] mb-4">Lesson Overview: Lesson 2</h2>
            <p className="text-gray-700 mb-4">
              Here are some additional ways to greet or interact in Lithuanian:
            </p>
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              ...
              <li>
                <strong>Iki greito susitikimo</strong> — "See you soon"
              </li>
              <li>
                <strong>Ar kalbi lietuviškai?</strong> — "Do you speak Lithuanian?"
              </li>
              <li>
                <strong>Kalbu truputį lietuviškai</strong> — "I speak a little Lithuanian"
              </li>
            </ul>
            <p className="text-gray-700 mt-4">
              Review these phrases, then try the matching game below to help reinforce your memory!
            </p>
          </div>
          ...
          {isLessonCompleted && (
            <div className="mt-4 text-center">
              <button
                onClick={() => {
                  markLessonCompleted("7ie60omtn8uob7i"); // Use dynamic lessonId if necessary
